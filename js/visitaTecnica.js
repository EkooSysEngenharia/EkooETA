...
export function montarRelatoriosVT(container){
 container.innerHTML=`<section class="vt-dashboard"><header class="vt-cabecalho"><div><p class="saudacao">Visita Técnica</p><h1>📄 Relatórios</h1><p>Relatórios exclusivos das visitas técnicas.</p></div></header><section class="vt-bloco"><div class="vt-vazio"><span>📄</span><strong>Nenhum relatório emitido ainda.</strong><p>Quando o formulário de Nova Visita Técnica for criado, os relatórios gerados aparecerão aqui.</p></div></section></section>`;
}
